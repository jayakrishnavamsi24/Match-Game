...
class MatchGame extends Component {
  ...
  getFilteredThumbnails = () => {
    ...
    // return filteredThumbnails.sort(() => Math.random() - 0.5)
  }
  ...
  thumbnailClick = id => {
    ...
    if (matchImgObj.id === id) {
      ...
      this.setState(prevState => ({
        ...
        matchImgObj: imagesList[randomNum],
      }))
    } else {
  ...
  render() {
    const {activeTabId, matchImgObj, score, time, isGameOver} = this.state
    ...
    return (
      <div className="bg-container">
        <nav className="header">
          ...
          />
          <ul>
            <li className="header-right-container">
              <p>
                {' '}
        ...
        {isGameOver && (
          <div className="game-over-view">
            <div className="score-card">
              ...
              <h1 className="score-val">{score}</h1>
              <button
                type="button"
